...
const seedDatabase = (db) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield db.collection('genres').insertMany(genres);
    const platforms = [
    ...
    yield db.collection('platforms').insertMany(platforms);
    const products = [
        {
            id: '1',
            name: 'Cyberpunk 2077',
    ...
    yield db.collection('products').insertMany(products);
    const shopProducts = [
    ...
    yield db.collection('products_platforms').insertMany(shopProducts);
